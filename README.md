...
`snapshot-tag` is the tag that is generated by the [snapshot-option](https://github.com/TakeoffTech/Publish-Docker-Github-Action#snapshot) and pushed
`flux-tag` is the tag that is generated by the [addfluxtag-option](https://github.com/TakeoffTech/Publish-Docker-Github-Action#addfluxtag) and pushed
